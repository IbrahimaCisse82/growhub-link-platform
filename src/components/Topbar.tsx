  ...
  return (
    <header className="h-[60px] bg-card border-b border-border flex items-center px-7 gap-3.5 sticky top-0 z-[150]">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="w-9 h-9 rounded-[9px] bg-card border border-border flex items-center justify-center cursor-pointer text-foreground/70 hover:bg-secondary hover:text-foreground transition-all">
          <MessageSquare className="w-[15px] h-[15px]" />
        </button>

        <div className="flex items-center gap-2 bg-card border border-border rounded-[10px] py-[5px] px-3 pl-1.5 cursor-pointer hover:border-primary/35 transition-all">
          ...
          <span className="text-[13px] font-medium">Sophie A.</span>
